...
tile-name-grid-gray-floor = grid gray floor tile
tile-name-white-corner = white corner tile
tile-name-steel-corner = steel floor corner tile
tile-name-monolith-white-floor = monolith white floor tile
tile-name-dark-small-floor = dark small floor tile
tile-name-dark-grid-floor = dark grid floor tile
tile-name-dark-corner = dark floor corner tile
tile-name-decayed-floor = decayed floor tile
